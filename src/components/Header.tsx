              ...
              <div className="px-2 space-y-1">
                ...
                {navigationItems.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className={` border-b border-b-gray-200 block px-3 py-4 font-medium transition-colors duration-200 text-gray-900 hover:text-orange-500`}
                    onClick={() => dispatch(closeMobileMenu())}
                  >
                    {item.name}
                ...
                <div className={`mt-4 pt-4`}>
                  <div className={`border-b border-b-gray-200 font-bold text-md mb-4 py-4 px-3 text-gray-900`}>Minha Conta</div>
                  <a
                    href="#entrar"
                    className={`border-b border-b-gray-200 block px-3 py-4 font-medium transition-colors duration-200 text-gray-900 hover:text-orange-500`}
                    onClick={() => dispatch(closeMobileMenu())}
